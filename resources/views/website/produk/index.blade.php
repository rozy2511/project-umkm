    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            @forelse ($products as $item)
                <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-[#e8d6c4]
                    ...
                    <div class="p-5 text-[#5a4633]">
                        ...
                        <a href="https://wa.me/628123456789?text=Saya%20ingin%20pesan%20{{ urlencode($item->name) }}"
            ...
            @empty
                <p class="text-center text-gray-600 col-span-3">Belum ada produk.</p>
            @endforelse
